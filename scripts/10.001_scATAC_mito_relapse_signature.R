...
for(p in unique(scATAC_ref$patient)){
  ...
  pdf(paste0("outputs/scATAC_plots/",p,"_scATAC_mito_clone_violin_relapse_signature_peaks_enrichment.pdf"), width = 8, height = 5)
  print(p1)
  dev.off()
  ...
  #visualize two plots above side-by-side
  pdf(paste0("outputs/scATAC_plots/",p,"_scATAC_mito_clone_boxplot_relapse_signature_peaks_enrichment.pdf"), width = 8, height = 5)
  print(p1)
  dev.off()
  ...
  #visualize two plots above side-by-side
  pdf(paste0("outputs/scATAC_plots/",p,"_scATAC_timepoint_boxplot_relapse_signature_peaks_enrichment.pdf"), width = 4, height = 5)
  print(p1)
  dev.off()
